          ...
          components: [
            {
              ...
              components: [
                { type: ComponentType.TextInput, label: `🍥゛Monggo di isi surat e`, placeholder: `Apa yang mau kamu sampein ke {user}?`, style: TextInputStyle.Paragraph, custom_id: interaction.data.target_id }
              ]
            }
          ]
        }
